      ...
      <div className="care-container">
        ...
        <div className='care-content-container'>
            <div className='care-section'>
              <h3>Socializing</h3>
              <p>
                Rabbits are social animals. The best thing you can do for them is to get them at least one more rabbit.
                If you are however unable to do so, make sure you yourself are spending a lot of time with them.
                If your bunny gets too lonely it can lead to depression and even death.
              </p>
            </div>
            <div className='care-section'>
              <h3>Grooming</h3>
              ...
              <p>
              Clip your bunnies nails ideally every few months. If you are unable to do so yourself, ask your vet to do it for you.
              </p>
            </div>
            <div className='care-section'>
